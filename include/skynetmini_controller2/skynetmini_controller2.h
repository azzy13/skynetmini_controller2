...
struct B_EnabledSubsystem_skynetmini_T {
  SL_Bus_skynetmini_controller2_std_msgs_Float64 In1;/* '<S10>/In1' */
};

/* Block signals (default storage) */
struct B_skynetmini_controller2_T {
  B_EnabledSubsystem_skynetmini_T EnabledSubsystem_e;/* '<S5>/Enabled Subsystem' */
...
struct P_skynetmini_controller2_T_ {
  ...
  SL_Bus_skynetmini_controller2_std_msgs_Float64 Constant_Value_h;/* Computed Parameter: Constant_Value_h
                                                                   ...
                                                                   */
  real_T maximum_space_gap_for_calculati;/* Expression: 100
  ...
  real_T eco_accel_Value;              /* Expression: 0.5
                                        ...
                                        */
  P_EnabledSubsystem_skynetmini_T EnabledSubsystem_e;/* '<S5>/Enabled Subsystem' */
 ...
 * '<S5>'   : 'skynetmini_controller2/space_gap'
 * '<S6>'   : 'skynetmini_controller2/Ego Car Controller 1/accel_brake'
 * '<S7>'   : 'skynetmini_controller2/Ego Car Controller 1/accel_normal'
 * '<S8>'   : 'skynetmini_controller2/Ego Car Controller 1/balance_accel'
 * '<S9>'   : 'skynetmini_controller2/Ego Car Controller 1/calculate_acceleration'
 * '<S10>'  : 'skynetmini_controller2/ego_car_speed/Enabled Subsystem'
 * '<S11>'  : 'skynetmini_controller2/space_gap/Enabled Subsystem'
 */
